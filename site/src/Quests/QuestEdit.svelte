...
<div class="wrapper">
    ...
    <label for="alertTrackedAspectInput">Aspekt Tracking abfragen?</label>
    <Input
        id="alertTrackedAspectInput"
        name="alertTrackedAspectInput"
        type="select"
        bind:value={quest.alertTrackedAspect}
    >
        <option value={null}> -- Kein Aspekt -- </option>
        <option>DE</option>
    </Input>
