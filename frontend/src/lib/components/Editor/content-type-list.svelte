...
export let fetchContentMetaData: (offset: number, limit: number, query?: string) => Promise<ContentMetadata>; 
...
<div > 
    ...
    <div class="grid space-y-2 space-x-2 list" style="--list-cols: {listCols}">
        ...
        <div on:click|preventDefault={(e) => selectElement(e,elem)} class="clickable my-2 p-2 bg-slate-50" class:selected="{selectedId === elem._id}">
